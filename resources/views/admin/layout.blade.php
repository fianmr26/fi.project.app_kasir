...
<body>
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-center">
                        <div class="logo shadow rounded">
                            <a href="{{ route('home') }}">
                                <img src='{{ asset('shop/' . Auth::user()->shop->path . '') }}' alt="Logo"
                                    srcset="" style="height:100px;" class="rounded">
                            </a>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item {{ request()->routeIs('category') || request()->routeIs('categoryCreate') ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item {{ request()->routeIs('products') || request()->routeIs('productCreate') || request()->routeIs('productAddImages') || request()->routeIs('productEdit') ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item {{ request()->routeIs('orders') || request()->routeIs('orderDetail') ? 'active' : '' }}">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#modalUpdatePassword">Change password</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="{{ route('logout') }}"
        ...
        <div class="modal fade" id="modalUpdatePassword" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="modalUpdatePasswordLabel" aria-hidden="true">
